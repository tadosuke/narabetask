...
/**
 * TaskWaitTimeSliderコンポーネントのプロパティ
 */
interface TaskWaitTimeSliderProps {
  /** 待ち時間（分） */
  waitTime: number;
  /** 待ち時間変更時のハンドラ */
 ...
 * タスク待ち時間スライダーコンポーネント
 */
export const TaskWaitTimeSlider: React.FC<TaskWaitTimeSliderProps> = ({
  waitTime,
  onWaitTimeChange,
}) => {
  return (
